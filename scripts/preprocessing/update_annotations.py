...
python scripts/preprocessing/update_annotations.py annotations/josh_annotations.jsonl $SEMCOR_PATH  --mwe_vocab mwe_vocab.txt
python scripts/preprocessing/update_annotations.py annotations/jake_annotations.jsonl $SEMCOR_PATH  --mwe_vocab mwe_vocab.txt
